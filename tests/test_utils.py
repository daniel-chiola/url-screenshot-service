...
def test_url_to_filename():
    ...
    assert utils.url_to_filename("https://google.com") == "screenshot_google_com.jpeg"
    assert utils.url_to_filename("http://example.org/path/to/page") == "screenshot_example_org.jpeg"
    assert utils.url_to_filename("https://sub.domain.co.uk/") == "screenshot_sub_domain_co_uk.jpeg"
